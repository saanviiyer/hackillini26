...
{
  // Request both bytes in ONE transaction
  Wire.requestFrom((uint8_t)0x07, (uint8_t)2);
  ...
  {
    // If we didn’t get 2 bytes, return an invalid marker
    *ULTRASONIC_Get = 65535;
    // flush anything leftover
